...
#fruityvice_normalized = pandas.json_normalize(fruityvice_response.json()) # this line has been moved
# output data as a table
# streamlit.dataframe(fruityvice_normalized)  # this line has been moved.
...
#add_my_fruit = streamlit.text_input('What fruit would you like to add?', 'Kiwi') #This line has been moved and refacoted
#streamlit.write('Thanks for adding ', add_my_fruit) # this line has been moved and refactored

#this will not work correctly, but just go with it for now
#my_cur.execute("insert into fruit_load_list values ('from streamlit')") This line has been moved
